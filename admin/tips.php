<?php
	...
	$id=$_REQUEST['id'];
	$qry="select * from beauty where b_id=".$id;
	$res=mysql_query($qry);
...
<?php
	if(isset($_REQUEST['up']))
	{
		...
		$p2=$_POST['p2'];
		$p3=$_POST['p3'];
		$up="update beauty SET b_des1='".$p1."',b_des2='".$p2."',b_des3='".$p3."' where b_id='$id'";
		echo $up;
			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-plus"></i>Beauty Tips</h2>
						<div class="box-icon">
                ...
                <td>
                <label class="in"><?php echo $row[1]; ?></label>
                </td>
                </tr>
                <tr>
                <td>
                ...
                <td><textarea name="p1" class="text" id="inputWarning"><?php echo $row[2]; ?></textarea></td>
                </tr>
                <tr>
                <td>
                ...
                <td>
                <textarea name="p2" class="text" id="inputWarning"><?php echo $row[3]; ?></textarea>
                </td>
                </tr>
                <tr>
                <td>
                ...
                <td>
                <textarea name="p3" class="text" id="inputWarning"><?php echo $row[4]; ?></textarea>
                </td>
                </tr>
                <tr>
                <td>&nbsp;</td>

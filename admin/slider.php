...
<?php
    ...
    if(isset($_REQUEST['id'])) 
	{
		...
		$del=$_REQUEST['id'];
		$query = "delete from slider where p_id=".$del;
...
<body>
	...
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<div><a href="preupload.php">Add New Photos</a></div>
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-plus"></i>Slider Images</h2>
						<div class="box-icon">
